...
public class ProducerExample {
    ...
    public static void main(final String[] args) {
        final Properties props = new Properties() {{
            ...
            put(SASL_JAAS_CONFIG,         "org.apache.kafka.common.security.plain.PlainLoginModule required username='USLOWVBQGBMZZ6WX' password='R6idX4XX3WyGAHrrA5yJ46K5tdwruERt2mCMkYJieHdOcQxmfjVd9iCl7rrQ/ncB';");
        ...
        final String topic = "notifications_topic";

        String[] users = {"prabhu", "mayuresh", "omkar", "sandeep", "digvijay", "santosh"};
